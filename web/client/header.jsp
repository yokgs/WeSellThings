            ...
            <div class="d-inline-flex align-items-center">
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        %>
                        <button class="dropdown-item" type="button"><a href="connexion.html" class="dropdown-item">Se connecter</a></button>
                        <%} else {%>
                        ...
                        <button class="dropdown-item" type="button">Mes Commandes</button>                     
                    </div>
                </div> 
            ...
            <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav mr-auto py-0">
                        ...
                        <a href="produit.jsp" class="nav-item nav-link">Shop Detail</a>
